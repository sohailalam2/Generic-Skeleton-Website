...
(function () {
    var g = ["Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0"], h = function () {
        var c = !1;
        try {
            c = window && "localStorage"in window && "getItem"in localStorage
        } catch (a) {
        }
        return c
    }();
    define(function () {
        var c = {createXhr: function () {
            var a, d, b;
            ...
            b.onreadystatechange = function (a) {
                4 === b.readyState && d(b.responseText)
            };
            b.send(null)
        }, load: function (a, d, b, e) {
            var f = d.toUrl(a);
            if (h)if (e = localStorage.getItem(f), null !== e)b.fromText(a, e); else {
                c.get(f, function (c) {
                    c += "\n //@ sourceURL=" + a;
                    b.fromText(a, c);
                    d([a], function (a) {
