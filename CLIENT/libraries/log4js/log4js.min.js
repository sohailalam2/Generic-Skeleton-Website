...
var Log4js = {version: "1.0", applicationStartDate: new Date(), loggers: {}, getLogger: function (categoryName) {
...
Log4js.Level.prototype = {toLevel: function (sArg, defaultLevel) {
    if (sArg === null) {
        return defaultLevel;
    }
...
Log4js.CustomEvent.prototype = {addListener: function (method) {
...
Log4js.LoggingEvent.prototype = {getFormattedTimestamp: function () {
    if (this.logger) {
...
Log4js.Logger.prototype = {addAppender: function (appender) {
...
Log4js.Appender.prototype = {doAppend: function (loggingEvent) {
    return;
}, doClear: function () {
    return;
...
Log4js.Layout.prototype = {format: function (loggingEvent) {
    return "";
...
Log4js.ConsoleAppender.prototype = Log4js.extend(new Log4js.Appender(), {setAccessKey: function (key) {
    this.accesskey = key;
}, initialize: function () {
    if (!this.inline) {
        var doc = null;
...
Log4js.MetatagAppender.prototype = Log4js.extend(new Log4js.Appender(), {doAppend: function (loggingEvent) {
    var now = new Date();
...
Log4js.AjaxAppender.prototype = Log4js.extend(new Log4js.Appender(), {doAppend: function (loggingEvent) {
...
Log4js.FileAppender.prototype = Log4js.extend(new Log4js.Appender(), {doAppend: function (loggingEvent) {
    try {
        var fileHandle = null;
...
Log4js.WindowsEventAppender.prototype = Log4js.extend(new Log4js.Appender(), {doAppend: function (loggingEvent) {
    var winLevel = 4;
...
Log4js.JSAlertAppender.prototype = Log4js.extend(new Log4js.Appender(), {doAppend: function (loggingEvent) {
...
Log4js.MozillaJSConsoleAppender.prototype = Log4js.extend(new Log4js.Appender(), {doAppend: function (loggingEvent) {
    try {
        netscape.security.PrivilegeManager.enablePrivilege("UniversalXPConnect");
...
Log4js.OperaJSConsoleAppender.prototype = Log4js.extend(new Log4js.Appender(), {doAppend: function (loggingEvent) {
...
Log4js.SafariJSConsoleAppender.prototype = Log4js.extend(new Log4js.Appender(), {doAppend: function (loggingEvent) {
...
Log4js.BrowserConsoleAppender.prototype = Log4js.extend(new Log4js.Appender(), {doAppend: function (loggingEvent) {
...
Log4js.SimpleLayout.prototype = Log4js.extend(new Log4js.Layout(), {format: function (loggingEvent) {
...
Log4js.BasicLayout.prototype = Log4js.extend(new Log4js.Layout(), {format: function (loggingEvent) {
...
Log4js.HtmlLayout.prototype = Log4js.extend(new Log4js.Layout(), {format: function (loggingEvent) {
...
Log4js.XMLLayout.prototype = Log4js.extend(new Log4js.Layout(), {format: function (loggingEvent) {
    ...
    return "<log4js:eventSet version=\"" + Log4js.version + "\" xmlns:log4js=\"http://log4js.berlios.de/2007/log4js/\">\n";
}, getFooter: function () {
...
Log4js.JSONLayout.prototype = Log4js.extend(new Log4js.Layout(), {format: function (loggingEvent) {
    var useragent = "unknown";
    try {
        useragent = navigator.userAgent;
    } catch (e) {
...
Log4js.PatternLayout.prototype = Log4js.extend(new Log4js.Layout(), {getContentType: function () {
    return "text/plain";
}, getHeader: function () {
    return null;
}, getFooter: function () {
...
Log4js.FifoBuffer.prototype = {push: function (obj) {
...
Log4js.DateFormatter.prototype = {formatDate: function (vDate, vFormat) {
